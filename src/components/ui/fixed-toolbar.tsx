...
export function FixedToolbar({ className, ...props }: React.ComponentProps<typeof Toolbar>) {
  ...
  return (
    <Toolbar
      {...props}
      className={cn(
        'fixed top-[57px] z-10 justify-between overflow-x-auto rounded-t-lg border-b border-b-border bg-background/95 p-1 backdrop-blur-sm supports-backdrop-blur:bg-background/60',
